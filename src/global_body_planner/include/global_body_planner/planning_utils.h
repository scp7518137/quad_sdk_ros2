...
// In ROS 2, generated message types live in the `msg` sub-namespace
// (e.g. quad_msgs::msg::RobotPlan). Provide compatibility aliases so legacy
// bare `pkg::Type` references used throughout this package still resolve.
namespace quad_msgs {
using msg::RobotPlan;
using msg::RobotState;
using msg::GRFArray;
}  // namespace quad_msgs
