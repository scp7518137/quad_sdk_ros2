"""ROS2 port of global_body_planner example.launch.

Note: the ROS1 file loaded $(find local_footstep_planner)/../config/
project_params.yaml, which no longer exists; the standard global params
are attached to each node instead.
"""
