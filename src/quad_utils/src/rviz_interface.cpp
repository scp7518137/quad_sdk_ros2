...
RVizInterface::RVizInterface(rclcpp::Node::SharedPtr node)
    : node_(node),
      estimate_base_tf_br_(node),
      ground_truth_base_tf_br_(node),
      trajectory_base_tf_br_(node) {
  ...
  quad_utils::loadROSParam(
      node_, "topics/visualization/joint_states/ground_truth",
  ...
  trajectory_state_sub_ = node_->create_subscription<quad_msgs::msg::RobotState>(
