...
class RVizInterface {
 public:
   ...
   * @param[in] node ROS 2 node to publish and subscribe from
   * @return Constructed object of type RVizInterface
   */
  RVizInterface(rclcpp::Node::SharedPtr node);

  /**
   * @brief Calls rclcpp spin_some and pubs data at set frequency
   */
  void spin();
 ...
 private:
  ...
  /// ROS 2 subscriber for the global plan
  rclcpp::Subscription<quad_msgs::msg::RobotPlan>::SharedPtr global_plan_sub_;

  /// ROS 2 subscriber for the local plan
  rclcpp::Subscription<quad_msgs::msg::RobotPlan>::SharedPtr local_plan_sub_;

  /// ROS 2 subscriber for the current
  rclcpp::Subscription<quad_msgs::msg::GRFArray>::SharedPtr grf_sub_;

  /// ROS 2 subscriber for the body plan
  rclcpp::Subscription<quad_msgs::msg::RobotPlan>::SharedPtr
      discrete_body_plan_sub_;

  /// ROS 2 subscriber for the discrete foot plan
  rclcpp::Subscription<quad_msgs::msg::MultiFootPlanDiscrete>::SharedPtr
      foot_plan_discrete_sub_;

  /// ROS 2 subscriber for the continuous foot plan
  rclcpp::Subscription<quad_msgs::msg::MultiFootPlanContinuous>::SharedPtr
      foot_plan_continuous_sub_;

  /// ROS 2 Publisher for the interpolated global plan vizualization
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr
      global_plan_viz_pub_;

  /// ROS 2 Publisher for the interpolated local plan vizualization
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr
      local_plan_viz_pub_;

  /// ROS 2 Publisher for the current GRFs
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr
      current_grf_viz_pub_;

  /// ROS 2 Publisher for local plan orientation vizualization
  rclcpp::Publisher<geometry_msgs::msg::PoseArray>::SharedPtr
      local_plan_ori_viz_pub_;

  /// ROS 2 Publisher for the interpolated global plan grf vizualization
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr
      global_plan_grf_viz_pub_;

  /// ROS 2 Publisher for the interpolated local plan grf vizualization
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr
      local_plan_grf_viz_pub_;

  /// ROS 2 Publisher for the discrete body plan vizualization
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr
      discrete_body_plan_viz_pub_;

  /// ROS 2 Publisher for the footstep plan visualization
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr
      foot_plan_discrete_viz_pub_;

  /// ROS 2 Publisher for the state estimate body trace
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr
      state_estimate_trace_pub_;

  /// ROS 2 Publisher for the ground truth state body trace
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr
      ground_truth_state_trace_pub_;

  /// ROS 2 Publisher for the trajectory state body trace
  rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr
      trajectory_state_trace_pub_;

  /// ROS 2 Publisher for the swing leg 0 visualization
  rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr
      foot_0_plan_continuous_viz_pub_;

  /// ROS 2 Publisher for the foot 1 plan visualization
  rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr
      foot_1_plan_continuous_viz_pub_;

  /// ROS 2 Publisher for the foot 2 plan visualization
  rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr
      foot_2_plan_continuous_viz_pub_;

  /// ROS 2 Publisher for the foot 3 plan visualization
  rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr
      foot_3_plan_continuous_viz_pub_;

  /// ROS 2 Publisher for the estimated joint states visualization
  rclcpp::Publisher<sensor_msgs::msg::JointState>::SharedPtr
      estimate_joint_states_viz_pub_;

  /// ROS 2 Publisher for the ground truth joint states visualization
  rclcpp::Publisher<sensor_msgs::msg::JointState>::SharedPtr
      ground_truth_joint_states_viz_pub_;

  /// ROS 2 Publisher for the trajectory joint states visualization
  rclcpp::Publisher<sensor_msgs::msg::JointState>::SharedPtr
      trajectory_joint_states_viz_pub_;

  /// ROS 2 Subscriber for the state estimate
  rclcpp::Subscription<quad_msgs::msg::RobotState>::SharedPtr
      state_estimate_sub_;

  /// ROS 2 Subscriber for the ground truth state
  rclcpp::Subscription<quad_msgs::msg::RobotState>::SharedPtr
  ...
  /// ROS 2 node to pub to and sub from
  rclcpp::Node::SharedPtr node_;

  /// ROS 2 Transform Broadcaster to publish the estimate transform for the base
  /// link
  tf2_ros::TransformBroadcaster estimate_base_tf_br_;

  /// ROS 2 Transform Broadcaster to publish the ground truth transform for the
  /// base link
  tf2_ros::TransformBroadcaster ground_truth_base_tf_br_;

  /// ROS 2 Transform Broadcaster to publish the trajectory transform for the base
  /// link
