...
class TrajectoryPublisher {
 public:
   ...
   * @param[in] node RCLCPP NodeSharedPtr to publish and subscribe from
   * @return Constructed object of type TrajectoryPublisher
   */
  TrajectoryPublisher(rclcpp::Node::SharedPtr node);
 ...
 private:
  ...
  quad_msgs::msg::RobotPlan body_plan_msg_;

  /// Robot state message
  quad_msgs::msg::RobotState::ConstSharedPtr robot_state_msg_;
