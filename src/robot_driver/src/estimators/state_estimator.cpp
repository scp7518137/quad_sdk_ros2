...
void StateEstimator::readIMU(const sensor_msgs::msg::Imu::ConstSharedPtr& last_imu_msg_,
...
void StateEstimator::readJointEncoder(
    const sensor_msgs::msg::JointState::ConstSharedPtr& last_joint_state_msg_,
    Eigen::VectorXd& jk) {
...
void StateEstimator::loadMocapMsg(
    geometry_msgs::msg::PoseStamped::ConstSharedPtr last_mocap_msg) {
