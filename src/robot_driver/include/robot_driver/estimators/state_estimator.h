...
class StateEstimator {
 public:
   ...
   * derived class
   * @param[in] nh ROS2 node
   */
  virtual void init(rclcpp::Node::SharedPtr nh) = 0;
   ...
   */
  void readIMU(const sensor_msgs::msg::Imu::ConstSharedPtr& last_imu_msg,
  ...
  void readJointEncoder(
      const sensor_msgs::msg::JointState::ConstSharedPtr& last_joint_state_msg,
      Eigen::VectorXd& jk);
   ...
   */
  void loadMocapMsg(geometry_msgs::msg::PoseStamped::ConstSharedPtr last_mocap_msg);
