...
class CompFilterEstimator : public StateEstimator {
 public:
   ...
   * @param[in] nh ROS2 node used to load parameters from yaml file
   */
   ...
   */
  void mocapCallBackHelper(const geometry_msgs::msg::PoseStamped::ConstSharedPtr& msg,
   ...
   */
  bool updateOnce(quad_msgs::msg::RobotState& last_robot_state_msg);
