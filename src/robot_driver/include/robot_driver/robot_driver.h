...
class RobotDriver {
 public:
   ...
   */
  RobotDriver(rclcpp::Node::SharedPtr node, int argc, char** argv);
 ...
 private:
   ...
   */
  void trajectoryStateCallback(const quad_msgs::msg::RobotState::ConstSharedPtr& msg);

  /**
   * @brief Callback to handle new leg override commands
   * @param[in] msg Leg override commands
   */
  void singleJointCommandCallback(const geometry_msgs::msg::Vector3::ConstSharedPtr& msg);

  /**
   * @brief Callback to handle control restart flag messages
   */
  void controlRestartFlagCallback(const std_msgs::msg::Bool::ConstSharedPtr& msg);

  /**
   * @brief Callback to handle new remote heartbeat messages
   * @param[in] msg Remote heartbeat message
   */
  void remoteHeartbeatCallback(const std_msgs::msg::Header::ConstSharedPtr& msg);
  ...
  /// Define ids for input types: Sit to stand
  const int SIT_TO_READY = 2;

  /// Define ids for input types: Stand to sit
  ...
  quad_msgs::msg::RobotPlan::ConstSharedPtr last_local_plan_msg_;

  /// Most recent state estimate
  quad_msgs::msg::RobotState last_robot_state_msg_;

  /// Most recent local plan
  quad_msgs::msg::GRFArray::ConstSharedPtr last_grf_array_msg_;

  /// Most recent remote  heartbeat
  std_msgs::msg::Header::ConstSharedPtr last_remote_heartbeat_msg_;
  ...
  /// Last mocap data
  geometry_msgs::msg::PoseStamped::ConstSharedPtr last_mocap_msg_;
